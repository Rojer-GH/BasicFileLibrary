...
public class SoundFile {
	 ...
	 */
	public SoundFile(String path, String fileName) {
		this(path + "/" + fileName);
	}
	 ...
	 */
	public void setAuxSend(float auxSend) {
		this.auxSend.setValue(auxSend);
	}
	 ...
	 */
	public void setAuxReturn(float auxReturn) {
		this.auxReturn.setValue(auxReturn);
	}
	...
	public void setReverbSend(float reverbSend) {
		this.reverbSend.setValue(reverbSend);
	}
	 ...
	 */
	public void setReverbReturn(float reverbReturn) {
		this.reverbReturn.setValue(reverbReturn);
	}
